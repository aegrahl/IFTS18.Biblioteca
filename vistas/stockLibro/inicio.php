...
<div class="card-deck container-fluid text-center justify-content-center pt-3 " id="libros-cont">
    <div class="row g-3">
        ...
        <div class="pb-5 mb-0 col-12  col-md-6 col-lg-3">
            <img src="/statics/img/libro1.jpeg">
            <p class="p-5 mt-2 text-center fs-2"><?php echo $libro->titulo  ?></p>

            <?php if ($_SESSION) { ?>
            <!-- Button to Open the Modal -->
            <a class="btn p-3 fs-5" type="button" data-bs-toggle="modal"
                data-bs-target="#<?php echo $libro->id_libro  ?>" href="">Consultar</a>
            <?php } else { ?>
        ...
        <!-- The Modal -->
        <div class="modal" id="<?php echo $libro->id_libro ?>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        Libro en venta por <?php echo $vendedor->nombre ?> <?php echo $vendedor->apellido ?> </br>
                        podes contactarlo con el email: <?php echo $vendedor->email ?></br>
                        o al celular: <?php echo $vendedor->telefono ?>
                    </div>
