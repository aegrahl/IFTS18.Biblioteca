          ...
          <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                ...
                <ul class="navbar-nav justify-content-end">
                    ...
                    <?php if(isset($_SESSION['rol'])){if($_SESSION['rol']==1){?>
                      ...
                      <?php if($_SESSION){?>
                        ...
                        <div class=" row">
                          <div class="d-flex justify-content-center">
                            <span class="text-white nav-link active" style="font-size:;">Bienvenido <?php echo ucfirst($_SESSION['nombre']) ?><br/></span>
                            <a class="text-white nav-link active" href="?controlador=login&accion=logout"><i class="fas fa-door-open"></i></a>
                          </div>
                        </div>
                      
                    <?php } else {?>
                        <a class="text-white nav-link active" href="?controlador=login&accion=inicio"><i class="fas fa-door-closed"></i>Login</a>
                      <?php } ?>
                    </li>
